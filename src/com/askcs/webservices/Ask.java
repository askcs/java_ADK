 ...
 * 
 */
@WebServiceClient(name = "Ask", targetNamespace = "urn:webservices.askcs.com", wsdlLocation = "http://ask70.ask-cs.nl/~ask/demo_110907/webservices/index.php?wsdl")
public class Ask
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://ask70.ask-cs.nl/~ask/demo_110907/webservices/index.php?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://ask70.ask-cs.nl/~ask/demo_110907/webservices/index.php?wsdl', retrying as a local file");
